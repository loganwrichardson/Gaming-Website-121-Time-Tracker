...
const characterInfo = (req, res) => {
    res.render('character-info', { 
        ...
        pcInfoList: [{
            ...
            magicItems: ['White Staf', 'Book of Hope', 'Jewel of Elements', 'Rat Totem', 'Kobol and Serum', 'Eye of Sauron', 'Bag of Holding', 'Narya(The Secret Flame)', 'Pipe', 'Old Toby', 'Fireworks'],
